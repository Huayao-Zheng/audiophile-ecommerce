  ...
  return (
    <div className="bg-[#101010]">
      <div className="Container relative grid place-items-center gap-y-12 py-12 text-white md:grid-cols-2 md:place-items-start md:gap-y-8 md:pt-14">
        ...
        {/* logo */}
        <Link href="/">
          <svg className="cursor-pointer" width="143" height="25" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <p className="text-center text-[15px] font-medium leading-[25px] text-white/50 md:col-span-2 md:text-left lg:col-span-1 lg:max-w-[540px]">
        ...
        <p className="font-bold text-white/50 md:mt-12 lg:col-[1/2] lg:mt-6">
        ...
        <div className="flex gap-4 md:self-end md:justify-self-end lg:col-[2/3] lg:row-[2/3]">
          ...
          <AiOutlineInstagram className="navLink text-2xl" />
        </div>
      </div>
    </div>
  );
