  ...
  return (
    <nav className="relative bg-[#0E0E0E] text-white">
      <div className="Container flex items-center justify-between py-8 md:justify-start md:gap-x-10">
        ...
        {/* Navigation links */}
        <div className="ml-14 hidden lg:block xl:ml-20">
          <NavLinks />
        </div>
        ...
        <div className="relative md:ml-auto">
          <button
            ...
            className={`cursor-pointer hover:text-[#D87D4A] ${showCart && 'text-[#D87D4A]'}`}
          >
            <svg fill="currentColor" width="23" height="20" xmlns="http://www.w3.org/2000/svg">
              <path
